...
public interface CmashVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link CmashParser#arrayDeclaration}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitArrayDeclaration(CmashParser.ArrayDeclarationContext ctx);
	/**
	 * Visit a parse tree produced by {@link CmashParser#matrixDeclaration}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMatrixDeclaration(CmashParser.MatrixDeclarationContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link CmashParser#numericalType}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitNumericalType(CmashParser.NumericalTypeContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link CmashParser#matrixAccess}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMatrixAccess(CmashParser.MatrixAccessContext ctx);
	/**
